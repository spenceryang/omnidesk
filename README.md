...
It takes a creative prompt plus optional creator-owned assets, produces a 10-scene plan for a 60-second music video, runs managed-agent quality checks, creates an audio-control plan, and generates selected video clips through the Gemini API stack.
...
6. Generate selected scene clips.
